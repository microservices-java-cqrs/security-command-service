...
@Setter
@Entity
@Table(schema="public", name="entity_types")
public class EntityTypeEntity {
    @Id
    @SequenceGenerator(name = "ENT_TYP_GENERATOR", sequenceName = "public.seq_entity_types", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ENT_TYP_GENERATOR")
